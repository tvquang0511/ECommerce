...
export const env = {
  ...
  REFRESH_TOKEN_PEPPER:
    process.env.REFRESH_TOKEN_PEPPER ?? "dev-refresh-pepper",

  // 2FA email OTP
  TWO_FACTOR_OTP_TTL_SECONDS: parseIntEnv(
  ...
  AUTH_COOKIE_SECURE: parseBoolEnv(
    process.env.AUTH_COOKIE_SECURE,
    envBoolDefaultSecure(),
  ),
  AUTH_COOKIE_SAME_SITE: (process.env.AUTH_COOKIE_SAME_SITE ?? "lax") as
    | "lax"
    | "strict"
    | "none",
