...
Thư mục này chứa tài liệu thiết kế và runtime flow của `order-subgraph`, là service học sâu nhất về `CQRS + DDD + Event Sourcing + Outbox`.
...
5. [ORDER_LIFECYCLE_AND_OUTBOX_RULES.md](ORDER_LIFECYCLE_AND_OUTBOX_RULES.md)
6. [ORDER_OUTBOX_DESIGN.md](ORDER_OUTBOX_DESIGN.md)
7. [ORDER_RUNTIME_FLOWS.md](ORDER_RUNTIME_FLOWS.md)
8. [ORDER_DEMO_E2E_GUIDE.md](ORDER_DEMO_E2E_GUIDE.md)
