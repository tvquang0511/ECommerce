...
2. [Architecture Standard](architecture/architecture-standard.md)
...
8. [User Service Database Diagram](diagrams/database-diagram/user-service.md)
9. Service-specific READMEs
10. Product-subgraph design docs
11. Learning roadmap docs
...
4. [RBAC Marketplace Access Control](architecture/rbac-marketplace-access-control.md)
5. [Services Specification](architecture/services.md)
6. [Component Diagram](diagrams/component-diagram.md)

### If you want the marketplace domain first
...
## 6) Documentation rules for this repo

- Architecture docs explain **why** and **what boundary**.
- Service docs explain **how the service behaves**.
- Domain docs explain **business workflows and roles**.
- Diagrams are source-of-truth visual summaries, not separate logic.
- If a schema changes, update the related database diagram and docs in the same task.
